...
from pointnet_util_noisy import pointnet_sa_module, point2sequence_module
...
def get_model(point_cloud, is_training, num_class, sigma_init, bn_decay=None):
    ...
    l1_xyz, l1_points, end_points['layer1_1'], end_points['layer1_2'] = point2sequence_module(l0_xyz, l0_points, 384, [32,64,128], [[64,64,128], [64,64,128], [128,128,128]], 128, 128, is_training, bn_decay, scope='layer1')
    end_points['l1'] = l1_points
    l2_xyz, l2_points, _ = pointnet_sa_module(l1_xyz, l1_points, npoint=None, radius=None, nsample=None, mlp=[256,512,1024], mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='layer2', end_points=end_points)
    ...
    return net, sigma, point_merge, end_points
...
def get_similarity_loss(end_points , sigma, sigmaf,  sigma_weight = 0.0025, batch_size=None):
