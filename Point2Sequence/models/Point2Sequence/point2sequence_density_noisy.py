...
from pointnet_util import   pointnet_sa_module_density
from pointnet_util_noisy import  point2sequence_module
...
def get_model(point_cloud, is_training, num_class, sigma_init, bn_decay=None):
    ...
    l2_xyz, l2_points, _ = pointnet_sa_module_density(l1_xyz, l1_points, npoint=None, radius=1.6, sigma=16*BANDW ,nsample=None, mlp=[256,512,1024], mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='layer2')
