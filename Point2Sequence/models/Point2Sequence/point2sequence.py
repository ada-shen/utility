...
def get_model(point_cloud, is_training, num_class, bn_decay=None):
    ...
    #l1_xyz, l1_points = point2sequence_module(l0_xyz, l0_points, 384, [32,64,128], [[64,64,128], [64,64,128], [128,128,128]], 128, 128, is_training, bn_decay, scope='layer1')
    #l1_xyz, l1_points = point2sequence_module(l0_xyz, l0_points, 384, [64,128], [[64,64,128], [128,128,128]], 128, 128, is_training, bn_decay, scope='layer1')
    #l1_xyz, l1_points = point2sequence_module(l0_xyz, l0_points, 384, [16,32,64], [[32,64,128], [64,64,128], [64,64,128]], 128, 128, is_training, bn_decay, scope='layer1')
