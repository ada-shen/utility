...
def get_model(point_cloud, is_training, num_class, sigma_init, bn_decay=None):
    ...
    l1_xyz, l1_points, end_points['layer1_1'], end_points['layer1_2'] = point2sequence_module(l0_xyz, l0_points, 384, [64,128], [[64,64,128], [128,128,128]], 128, 128, is_training, bn_decay, scope='layer1')
