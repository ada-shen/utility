...
def get_model(point_cloud, is_training, num_class, sigma_init, bn_decay=None, feature=None):
    ...
    c0_l0_xyz, c0_l0_points, c0_l0_indices = pointSIFT_nores_module_noise(l0_xyz, l0_points, radius=0.1, out_channel=64, is_training=is_training, bn_decay=bn_decay, scope='layer0_c0', merge='concat')
    ...
    # c1
    c0_l1_xyz, c0_l1_points, c0_l1_indices = pointSIFT_nores_module_noise(l1_xyz, l1_points, radius=0.25, out_channel=128, is_training=is_training, bn_decay=bn_decay, scope='layer1_c0')
    ...
    # c2
    c0_l2_xyz, c0_l2_points, c0_l2_indices = pointSIFT_nores_module_noise(l2_xyz, l2_points, radius=0.5, out_channel=256, is_training=is_training, bn_decay=bn_decay, scope='layer2_c0')
    l3_xyz, l3_points, l3_indices = pointnet_sa_module_noise(c0_l2_xyz, c0_l2_points, npoint=64, radius=0.4, nsample=32, mlp=[256,512], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer3')
    # c3
    c0_l3_xyz, c0_l3_points, c0_l3_indices = pointSIFT_nores_module_noise(l3_xyz, l3_points, radius=0.85, out_channel=512, is_training=is_training, bn_decay=bn_decay, scope='layer3_c0')
    l4_xyz, l4_points, l4_indices = pointnet_sa_module_noise(c0_l3_xyz, c0_l3_points, npoint=None, radius=None, nsample=None, mlp=[512,1024], mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='layer4')
