...
def get_model(point_cloud, is_training, num_class, sigma_init, bn_decay=None, feature=None):
    ...
    l1_xyz, l1_points, l1_indices = pointnet_sa_module_noise(l0_xyz, l0_points, npoint=512, radius=0.2, nsample=32, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')
    ...
    l2_xyz, l2_points, l2_indices = pointnet_sa_module_noise(l1_xyz, l1_points, npoint=128, radius=0.4, nsample=64, mlp=[128,128,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')

    c0_l2_xyz, c0_l2_points, c0_l2_indices = pointSIFT_nores_module_noise(l2_xyz, l2_points, radius=0.85, out_channel=256, is_training=is_training, bn_decay=bn_decay, scope='layer2_c0')
    l3_xyz, l3_points, l3_indices = pointnet_sa_module_noise(c0_l2_xyz, c0_l2_points, npoint=None, radius=None, nsample=None, mlp=[256,512,1024], mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='layer3')
    ...
    # end_points['fc256'] = tf.squeeze(net)
    ...
    # end_points['fc40'] = tf.squeeze(net)
    net = tf.squeeze(net)
