...
import numpy as np
import tf_util
from pointSIFT_util import point2sequence_module_noise
...
def get_model(point_cloud, is_training, num_class, sigma_init, bn_decay=None):
    ...
    # p2s add 3D weight module
    l1_xyz, l1_points = point2sequence_module_noise(l0_xyz, l0_points, 384, [16,32,64,128], [[32,64,128], [64,64,128], [64,64,128], [128,128,128]], 128, 128, is_training, bn_decay, scope='layer1')
